package com.example.adminfitpal.Model;

public class VideoUploadDetails {
    String video_slide, video_type, video_thum, video_url,video_name,video_description,video_category;

    public VideoUploadDetails(String video_slide, String video_type, String video_thum, String video_url, String video_name,
